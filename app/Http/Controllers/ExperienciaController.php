...
class ExperienciaController extends Controller
{
    ...
    public function show(Experience $experience)
    {
        ...
        $categories = category::all();
        $states = State::all();
        return view('viajes.experiencia', ['experiencia' => $experience, 'experiences' => $experiences, 'states' => $states, 'categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'titulo_en' => 'required',
            'lightdescription_en' => 'required',
            'longdescription_en' => 'required',
            'icons' => 'required',
            //'categories' => 'required',
        ...
        $experience = Experience::create([
            ...
            'lightdescription_en' => $request->lightdescription_en,
