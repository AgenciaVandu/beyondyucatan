<form action="{{ route('send.form.basic') }}" method="POST">
    @csrf
    @method('POST')
    @if (session()->get('locale') == 'es')
        <div class="row basic">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12  mt-4">
                <textarea class="form-control" name="message" id="mensaje" placeholder="Mensaje" rows="3"></textarea>
            </div>
    ...
    @else
        <div class="row basic">
            ...
            <div class="col-lg-6  col-md-12 col-sm-12 mt-4">
                <input name="phone" id="phone" type="phone" class="form-control" placeholder="Phone"
                    aria-label="phone">
            </div>
            <div class="col-lg-6  col-md-12 col-sm-12 mt-4">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12  mt-4">
                <textarea class="form-control" name="message" id="mensaje" placeholder="Mesagge" rows="3"></textarea>
            </div>
            <div class="boton mt-4">
